        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              desc: 'Our knowledgeable team is always ready to help with your questions and concerns.',
            },
            {
              title: 'Fast Delivery',
              desc: 'We ensure quick processing and shipping of your orders across the country.',
            },
          ].map((item, i) => (
            <div
              key={i}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              quote:
                'Fast shipping and excellent customer service. The 3D mats fit perfectly and are so easy to clean.',
            },
